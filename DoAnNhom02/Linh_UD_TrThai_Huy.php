...
<head>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
	...
	{
		$madh = $_POST['id'];
		$sql1 = "update donhang set TRANGTHAI=2 where MADH=".$madh;
		...
		$sql = "select * from donhang dh, khachhang kh WHERE dh.MAKH = kh.MAKH  LIMIT $start, $rows_per_page ";
		$sta = $pdo->prepare($sql);
		$sta->execute();
		if ($sta->rowCount() > 0)
		{
