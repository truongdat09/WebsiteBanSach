					...
					<div class="collapse" id="search-nav">
						<form class="navbar-left navbar-form nav-search mr-md-3">
							<div class="input-group">
								...
								<input type="text" name="txt_timkiem" placeholder="Tìm kiếm ..." class="form-control">
							</div>
						</form>
					</div>
		...
		<div class="main-panel">
        	<div class="content">
            	<div class="page-inner">
                    ...
                    <form method="get" action="Linh_NhanVien_TimKiem.php">
                    	<div class="row">
                    	<div class="col-md-12">
                        	<div class="card">
                                ...
                                <div class="card-body">
									<div class="table-responsive">
										<div id="basic-datatables_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                                            	...
                                            	<div class="col-sm-12 col-md-6">
                                                    ...
                                                    <div class="col-sm-12 col-md-6">
                                                    	<div id="basic-datatables_filter" class="dataTables_filter">
                                                    		<input class="form-control form-control-sm" type="text" placeholder="Tìm kiếm..." aria-label="Search" name="timkiem" >
                        									<button class="btn btn-primary btn-sm" >Tìm kiếm</button>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-6">
                                                    	<button class="btn btn-primary" data-id="<?php echo $dh['MADH']; ?>" ><a href="Linh_ThemNV.php" style="color:#FFF;">Thêm nhân viên</a></button>
                                                    </div>
                                             </div>
                    </form>
											...
											<thead>
												<tr role="row">
                                                	<th class="sorting_asc" tabindex="0" aria-controls="basic-datatables" rowspan="1" colspan="1" style="width: 100px;">Mã nhân viên</th> 
                                                    <th class="sorting" tabindex="0" aria-controls="basic-datatables" rowspan="1" colspan="1"  style="width: 100px;">Tên nhân viên</th>
                                                    <th class="sorting" tabindex="0" aria-controls="basic-datatables" rowspan="1" colspan="1" style="width: 100px;">Giới tính</th>
                                                    <th class="sorting" tabindex="0" aria-controls="basic-datatables" rowspan="1" colspan="1" style="width: 100px;">Số điện thoại</th>
                                                    <th class="sorting" tabindex="0" aria-controls="basic-datatables" rowspan="1" colspan="1" style="width: 100px;">Tài khoản</th>
                                                   	<th class="sorting" tabindex="0" aria-controls="basic-datatables" rowspan="1" colspan="1" style="width: 100px;"></th>
											...
											?>
                                            	 ...
                                            	 <tr role="row" class="odd" >
													...
													<td><?php echo $nv['TENDN']?></td>
                                                    <td>
                                                    	<div class="row mt--2">
                                                        		<div class="col-6"><button class="btn btn-warning"><a href="Linh_SuaNV.php?manv=<?php echo $nv['MANV']?>" style="color:#FFF;">Sửa</a></button></div>
                                                            	<div class="col-6"><button class="btn btn-danger" data-id="<?php echo $nv['MANV'] ?>" ><a href="Linh_XoaNV.php?manv=<?php echo $nv['MANV']?>" style="color:#FFF;">Xóa</a></button></div>
                                                            </div>
                                                    </td>
												</tr>
