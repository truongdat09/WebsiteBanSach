                    	...
                    	<div class="col-md-5 mx-auto">
							  <?php
                                 include ("Class/xl_NhanVien_CRUD.php");
								  ...
								  if (isset($_POST['update'])) {
									if (isset($_POST['name']) && isset($_POST['email']) && isset($_POST['mobile']) && isset($_POST['tendn'])) {
									  if (!empty($_POST['name']) && !empty($_POST['email']) && !empty($_POST['mobile']) && isset($_POST['tendn'])) {
										 
										$data['id'] = $id;
										$data['name'] = $_POST['name'];
										$data['mobile'] = $_POST['mobile'];
										$data['email'] = $_POST['email'];
										$data['tendn'] = $_POST['tendn'];
										...
										header("Location: Linh_SuaNV.php?id=$id");
									  }
									}
								  }
                              ?>
                              <form action="" method="post">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="name" value="<?php echo $row['TENNV']; ?>" class="form-control">
                                </div>
                                <div class="form-group">
                                  <label for="">Giới tính</label>
                                  <input type="text" name="email" value="<?php echo $row['GIOITINH']; ?>" class="form-control">
                                </div>
                                <div class="form-group">
                                  <label for="">Số điện thoại</label>
                                  <input type="text" name="mobile" value="<?php echo $row['SDT']; ?>" class="form-control">
                                </div>
                                <div class="form-group">
                                  <label for="">Tài khoản</label>
                                  <input type="text" readonly name="tendn" value="<?php echo $row['TENDN']; ?>" class="form-control">
                                </div>
                                <div class="form-group">
