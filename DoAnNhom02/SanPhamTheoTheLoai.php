...
//truyen id theo the loai
$id_theloai = (isset($_GET["id"]) == true) ? $_GET["id"] : "";
$pdo1_theloai = new PDO("mysql:host=localhost; dbname=dtb_ban_sach_3", "root", "");
$pdo1_theloai->query("set names utf8");
if ($id_theloai == 0) {
    $sql1_theloai = "select * from sach";
} else {
    $sql1_theloai = "SELECT * FROM sach, chude, theloai  WHERE sach.MACD = chude.MACD and chude.MATL = theloai.MATL and theloai.MATL = " . $id_theloai;
}
$sach = $pdo1_theloai->query($sql1_theloai);
$pdo1_theloai = null;
//truyen id theo chu de
